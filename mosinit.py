'''
Current clamp demo using Allen Brain's model 473561660.
...
from neuron473561660 import Neuron473561660
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473561660(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473561660; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-82.6876653035)
        h.fcurrent()
